...
/**
 * @author Single Shortest Path from
 *         https://github.com/apache/hama/blob/trunk/examples
 *         /src/main/java/org/apache/hama/examples/SSSP.java
 * 
 */

public class SingleShortestPathCpu {
		...
		public boolean parseVertex(LongWritable key, Text value,
			...
			for (int i = 0; i < split.length; i++) {
				if (i == 0) {
					...
					vertex.addEdge(new Edge<Text, IntWritable>(new Text(
							split2[0]), new IntWritable(Integer
							.parseInt(split2[1]))));
				}
			}
			return true;
	...
	public static void main(String[] args) throws IOException,
		...
		GraphJob ssspJob = new GraphJob(conf, SingleShortestPathCpu.class);
		// Set the job name
