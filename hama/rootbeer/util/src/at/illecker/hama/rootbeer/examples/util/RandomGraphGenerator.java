package at.illecker.hama.rootbeer.examples.util;
 ...
 * 
 * @author thomas.jungblut from
 *         https://github.com/thomasjungblut/thomasjungblut-
 *         common/blob/master/src/de/jungblut/bsp/RandomGraphGenerator.java
 * 
 */
public class RandomGraphGenerator {
	...
	static class RangeInputFormat extends
		...
		public List<InputSplit> getSplits(JobContext job) {
			...
			splits[numSplits - 1] = new RangeInputSplit(currentRow, totalRows
					- currentRow);
			List<InputSplit> arrayList = new ArrayList<InputSplit>(
					splits.length);
	...
	public static class RandomMapper extends
		...
		protected void map(Text key, NullWritable value, Context context)
				throws IOException, InterruptedException {
			// for SSSP we need: VERTEX_ID\t(n-tab separated
