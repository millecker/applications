...
public class MatrixMultiplicationHybridBSPOld
  ...
  public static BSPJob createMatrixMultiplicationHybridBSPConf(
    ...
    job.setBspClass(MatrixMultiplicationHybridBSPOld.class);
    // help Hama to locale the jar to be distributed
    job.setJarByClass(MatrixMultiplicationHybridBSPOld.class);
